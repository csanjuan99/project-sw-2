...
import com.app.medyapp.security.JwtEntryPoint;
import com.app.medyapp.security.JwtTokenFilter;
import com.app.medyapp.service.UserDetailsServiceImpl;
...
public class MainSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and().csrf().disable()
                ...
                .antMatchers(HttpMethod.POST, "/api/affiliate/beneficiary/all").permitAll()
                .antMatchers(HttpMethod.GET, "/api/affiliate/beneficiary/everyone").permitAll()
                .antMatchers(HttpMethod.GET, "/api/affiliate/all").permitAll()
                .antMatchers(HttpMethod.GET, "/api/affiliate/beneficiary/read/{id}").permitAll()
                .antMatchers(HttpMethod.GET, "/api/affiliate/read/{id}").permitAll()
                .antMatchers(HttpMethod.PUT, "/api/affiliate/update/{id}").permitAll()
                .antMatchers(HttpMethod.POST, "/api/affiliate/create/existing").permitAll()
                .antMatchers(HttpMethod.POST, "/api/affiliate/beneficiary/create").permitAll()
                ...
                .antMatchers(HttpMethod.DELETE, "/api/affiliate/beneficiary/delete/{id}").permitAll()
